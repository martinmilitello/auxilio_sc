...
import sys
#################################################################
 # PEGAR LAS REVENDEDORAS DE RIO GRANDE EN DEMAPAS.CSV SIN EL DIGITO VERIFICADOR
 # EN EXCEL: =IZQUIERDA(A2;LARGO(A2)-1)
#################################################################
...
#    cli_df.piso=cli_df.piso.fillna(0).astype(int)
    ...
    cabe_in_salida= rutasubida + "C" + mifecha + "_RIO" + mizona + "_xlsx.csv"
    deta_in_salida= rutasubida + "D" + mifecha + "_RIO" + mizona + "_xlsx.csv"
    cabe_not_salida= rutasubida + "C" + mifecha + "_USHUAIA" + mizona + "_xlsx.csv"
    deta_not_salida= rutasubida  + "D" + mifecha + "_USHUAIA" + mizona + "_xlsx.csv"
