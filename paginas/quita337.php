          ...
          <div class="row h-100 justify-content-center">
              ...
              <div class="col-md-1">
                  ...
                  <div class="col-md-10">
                          ...
                          <h3>Quita los pedidos con importes que sumen 337</h3>
          ...
          <div class="col-md-6">
              ...
              <div class="d-flex justify-content-center">
                  ...
                  <form>
                      ...
                      <input type="text" class="form-control" id="fecha" placeholder=<?php echo $hoy ?> aria-describedby="FechaHelp" >
                      </div>
         
                      <div class="form-group">
                          <label for="rutaped">Ruta o Path Cabecera y Detalle:</label>
                          <input type="text" class="form-control" id="rutaped" value ="/SUBIDASP/"aria-describedby="rutaHelp" readonly>
                          <small id="passHelp" class="form-text text-muted"></small>
                      </div>
                      <p>     </p>
                          <div class="d-flex justify-content-around">
                              
                              <button id="btneje337" type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Deben subirse todos los archivos Cabeceras y Detalles CSV a la Carpeta SUBIDASP, Los archivos procesados quedarán en la carpeta Salidas ">Ejecutar Proceso 337</button>
                          </div>
...
|           
                  ...
                  <div class="container shadow p-3 bg-light text-black rounded">
                          <h4>Descargas Disponibles en: SALIDAS\</h4>
                              ...
                              <table class="table table-success table-bordered" style='color: black'>
                                  ...
                                  <tbody>
                                      ...
                                      <tr class="table-primary" style='color:black'>
                                          ...
                                          <td><a title="Descargar Archivo" href="subidasp/<?php echo $archivos[$i]; ?>" download="<?php echo $archivos[$i]; ?>" style="color: blue; font-size:18px;"> <span class="bi bi-download" aria-hidden="true"></span> </a></td>
                                          <td><a title="Eliminar Archivo" href="paginas/Eliminar.php?name=../subidasp/<?php echo $archivos[$i]; ?>" style="color: red; font-size:18px;" onclick="return confirm('Esta seguro de eliminar el archivo?');"> <span class="bi bi-trash" aria-hidden="true"></span> </a></td>
                                      </tr>
