...
if len(sys.argv) == 4:
   ...
   # print("La ruta tal vez este mal")
    cabenombrearchivo = rutasubida + "cabe" + mifecha + ".csv"
    detanombrearchivo = rutasubida + "deta" + mifecha + ".csv"
  ...
  #  print(demapas_df_type)
    ...
    deta_df_in=deta_df[deta_df.n_comp.isin(cabe_df_in.n_comp)]
    ...
    cli_df['fecalta'] = pd.to_datetime(cli_df['fecalta'], errors='coerce')
...
#    cli_df.piso=cli_df.piso.fillna(0).astype(int)
    ...
    cabe_in_salida= rutasubida + "cabe" + mifecha + "_IN_" + mizona + "_xlsx.csv"
    deta_in_salida= rutasubida + "deta" + mifecha + "_IN_"+ mizona + "_xlsx.csv"
    cabe_not_salida= rutasubida + "cabe" + mifecha + "_NOT_" + mizona + "_xlsx.csv"
    deta_not_salida= rutasubida  + "deta" + mifecha + "_NOT_" + mizona + "_xlsx.csv"
    cli_salida=  rutasubida + "CLI" + mifecha + "_" + mizona + "Totales.csv"
    ...
    cli_df.to_csv(cli_salida,quoting=csv.QUOTE_NONNUMERIC, index=False, header=True, date_format='%Y-%m-%d')
